 ...
 * Use the [ListOfLocations.newInstance] factory method to
 * create an instance of this fragment.
 */
class ListOfLocations : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListOfLocations.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ListOfLocations().apply {
